<template>
    <div id="menu" class="bg-white/10 col-span-3 rounded-lg p-4">
        ...
        <div id="menu" class="flex flex-col space-y-2 my-5">
            ...
            <Link 
                ...
                <div class="flex flex-col space-y-2 md:flex-row md:space-y-0 space-x-2 items-center">
                    ...
                    <div>
                        <p 
                            :class="{'text-indigo-400': $page.url === '/dashboard'}"
                            class="font-bold text-base text-slate-200 leading-4 group-hover:text-indigo-400 ml-4">Clientes
                        </p>
                    </div>    
                </div>
            </Link>
            <Link 
                v-if="!canView"
                :href="route('schedules.mySchedules')" 
            ...
            <Link 
                ...
                :class="{ 'bg-white/10': $page.url === '/schedules' }"
                class="hover:bg-white/10 transition duration-150 ease-linear rounded-lg py-3 px-2 group">
                <div class="relative flex flex-col space-y-2 md:flex-row md:space-y-0 space-x-2 items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-8 h-8 stroke-indigo-500">
